...
#from matplotlib.backends.backend_bases.FigureCanvasBase import mpl_connect
...
class MyMplCanvas(FigureCanvas):
	def __init__(self, parent=None, width = 10, height = 12, dpi = 100, sharex = None, sharey = None):
		...
		self.fig.subplots_adjust(left=0.10, bottom=0.15, right=0.95, top=0.9)
		self.xtitle="x-Axis"
		self.ytitle="y-Axis"
...
class MPL_Widget(QWidget):
    def __init__(self, parent = None):
        ...
        self.toolbar = NavigationToolbar(self.canvas, self.canvas)#, direction = 'v')
